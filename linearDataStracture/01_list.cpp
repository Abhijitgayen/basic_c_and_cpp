...
//3.list.front( ); return the front elelment in this list of list
...
int main(){
    ...
    list1.push_front(-10);
    //in vector we have only push_back but in list there are push_front
    //pop_back and pop_front also there
    list_print( list1);
    list1.pop_back();
    list1.pop_front();
    cout<<"list1 : ";
